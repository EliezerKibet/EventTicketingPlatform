                        ...
                        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6 mb-6">
                            ...
                            {event.isOnline && event.onlineUrl && (
                                <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                    <h3 className="text-lg font-semibold text-blue-900 mb-2">Online Event</h3>
                                    <p className="text-blue-700">This event will be held online. Access details will be provided after purchase.</p>
                                </div>
                            )}
                            ...
                            {cart.length > 0 && (
                                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className="text-sm text-green-700">{getTotalItems()} items</span>
                                    </div>
                            ...
                            <div className="space-y-4">
                                {ticketTypes.length === 0 ? (
                                    <div className="text-center py-8">
                                        <p className="text-gray-600">No tickets available yet</p>
                                    </div>
                                ) : (
                                    ticketTypes.map((ticketType) => (
                                        <div key={ticketType.ticketTypeId} className="border border-gray-200 rounded-lg p-4">
